...
class pisol_dpmw_options{
    ...
    function __construct($plugin_name){
        ...
        $this->settings = array(
            ...
            array('field'=>'pi_dpmw_partial_amt_calculation', 'label'=>__('Partial payment based on', 'disable-payment-method-for-woocommerce'), 'desc'=>__('How the partial payment amount will be calculated', 'disable-payment-method-for-woocommerce'), 'type'=>'select', 'default'=>"fixed", 'value'=>['fixed' => 'Fixed amount', 'percentage' => 'Percentage of Total']),

            array('field'=>'pi_dpmw_partial_amt', 'label'=>__('Partial payment', 'disable-payment-method-for-woocommerce'), 'desc'=>__('partial payment amt will be flat amount or percent of the total', 'disable-payment-method-for-woocommerce'), 'type'=>'text', 'default'=>"0"),

            array('field'=>'pi_dpmw_partial_payment_fee_pro', 'label'=>__('Partial payment fee', 'disable-payment-method-for-woocommerce'), 'desc'=>__('Charge extra fee when customer select partial payment option', 'disable-payment-method-for-woocommerce'), 'type'=>'text', 'default'=>"0", 'pro' => true),
