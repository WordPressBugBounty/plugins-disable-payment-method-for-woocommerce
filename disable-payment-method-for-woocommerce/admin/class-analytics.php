...
class Pi_Dpmw_Analytics{
    ...
    public function show_tracker_notice() {
        ...
        $notice .= '<p>'.__("Hi, your support can make a big difference!", 'disable-payment-method-for-woocommerce').'</p>';
        $notice .= '<p>'.__("We collect only technical data — including the plugin version, WordPress version, WooCommerce version, and site url — solely to improve compatibility and enhance plugin features.", 'disable-payment-method-for-woocommerce').'</p>';
        ...
        $notice .= sprintf(
            ...
            __('I Don\'t Help', 'disable-payment-method-for-woocommerce')
        );
        $notice .= sprintf(
            ...
            __('I Will Help', 'disable-payment-method-for-woocommerce')
        );
